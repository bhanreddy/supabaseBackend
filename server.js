...
import hallTicketRouter from './routes/hallTicketRoutes.js';
...
import adminStudentPortfolioRouter from './routes/adminStudentPortfolioRoutes.js';
...
import feeDueSlipsRouter from './routes/feeDueSlipsRoutes.js';
...
app.use('/api/v1/fee-due-slips', feeDueSlipsRouter);
app.use('/api/v1/hall-tickets', requireFeature('nav.results'), hallTicketRouter);
...
app.use('/api/v1/admin/student-portfolio', adminStudentPortfolioRouter);
